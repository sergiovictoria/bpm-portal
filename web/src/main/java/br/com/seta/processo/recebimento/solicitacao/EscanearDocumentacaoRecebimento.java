...
public class EscanearDocumentacaoRecebimento extends DadosSolicitacaoIntencaoCompraTemplate {

	private static final long serialVersionUID = 1L;
	
	public EscanearDocumentacaoRecebimento(PageParameters pageParameters)
			throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);
		
		EscanearDocumentacaoRecebimentoFormulario formulario = new EscanearDocumentacaoRecebimentoFormulario(pageParameters, getTaskId(), getCaseId(), this.getPageReference());
