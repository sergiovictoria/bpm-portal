 ...
 *
 */
public class TimeLineProvider extends SortableDataProvider<HumanTask, String> {
    ...
    public TimeLineProvider() throws HttpStatus401Exception, ParseException, IOException, HttpStatusException{
	...
	public Iterator<? extends HumanTask> iterator(long first, long count) {
		List<HumanTask> taskList;
		try {
			taskList = restApi.retriveTaskList(user, first, count, filter);
