...
public class IntegracaoParaPagamento extends DadosSolicitacaoIntencaoCompraTemplate {
	
	private static final long serialVersionUID = 1L;

	public IntegracaoParaPagamento(PageParameters pageParameters) throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);
		
		IntegracaoParaPagamentoFormulario formulario = new IntegracaoParaPagamentoFormulario(pageParameters, getTaskId(), getCaseId(), this.getPageReference());
