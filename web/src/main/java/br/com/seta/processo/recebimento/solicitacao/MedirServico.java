...
public class MedirServico extends DadosSolicitacaoIntencaoCompraTemplate {
	
	private static final long serialVersionUID = 1L;

	public MedirServico(PageParameters pageParameters) throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);
		
		MedirServicoFormulario formulario = new MedirServicoFormulario(pageParameters, getTaskId(), getCaseId(), this.getPageReference());
