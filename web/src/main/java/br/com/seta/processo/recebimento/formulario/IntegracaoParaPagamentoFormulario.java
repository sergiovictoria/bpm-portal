...
import br.com.seta.processo.recebimento.secoesBotoes.SecaoBotoesIntegraParaPagamento;


public class IntegracaoParaPagamentoFormulario extends BaseFormularioRecebimentoPage {
	private static final long serialVersionUID = 1L;

	public IntegracaoParaPagamentoFormulario(PageParameters pageParameters,
		...
		SecaoBotoesIntegraParaPagamento secaoBotoes = new SecaoBotoesIntegraParaPagamento("secaoBotoes", paginaAnterior, this);		
