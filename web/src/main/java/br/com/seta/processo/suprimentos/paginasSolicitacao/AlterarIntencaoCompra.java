...
import br.com.seta.processo.suprimentos.paginasFormulario.AlterarIntencaoCompraFormulario;

public class AlterarIntencaoCompra extends DadosSolicitacaoIntencaoCompraTemplate {
	private static final long serialVersionUID = 1L;

	public AlterarIntencaoCompra(PageParameters pageParameters)
			throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		
		super(pageParameters);

		AlterarIntencaoCompraFormulario formulario = new AlterarIntencaoCompraFormulario( pageParameters, getRequisicao(), getSolicitacao(), this.getPageReference());
