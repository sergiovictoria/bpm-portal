...
import br.com.seta.processo.suprimentos.paginasFormulario.AprovacaoIntencaoCompraFormulario;

public class AprovacaoIntencaoCompra extends DadosSolicitacaoIntencaoCompraTemplate {
	private static final long serialVersionUID = 1L;

	public AprovacaoIntencaoCompra(PageParameters pageParameters)
			throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);	
		
		AprovacaoIntencaoCompraFormulario formulario = new AprovacaoIntencaoCompraFormulario( pageParameters, getRequisicao(), getSolicitacao(), this.getPageReference());
