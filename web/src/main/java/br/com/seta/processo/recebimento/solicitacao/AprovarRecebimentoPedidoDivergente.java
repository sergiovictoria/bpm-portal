...
public class AprovarRecebimentoPedidoDivergente extends DadosSolicitacaoIntencaoCompraTemplate {
	
	private static final long serialVersionUID = 1L;

	public AprovarRecebimentoPedidoDivergente(PageParameters pageParameters) throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);
		
		AprovarRecebimentoPedidoDivergenteFormulario formulario = new AprovarRecebimentoPedidoDivergenteFormulario(pageParameters, getTaskId(), getCaseId(), this.getPageReference());
