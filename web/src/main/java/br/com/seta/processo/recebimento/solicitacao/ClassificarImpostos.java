...
public class ClassificarImpostos extends DadosSolicitacaoIntencaoCompraTemplate {
	
	private static final long serialVersionUID = 1L;

	public ClassificarImpostos(PageParameters pageParameters) throws HttpStatus401Exception, HttpStatus404Exception,
			ClientProtocolException, GenericHttpStatusException, IOException {
		super(pageParameters);
		
		ClassificarImpostosFormulario formulario = new ClassificarImpostosFormulario(pageParameters, getTaskId(), getCaseId(), this.getPageReference());
