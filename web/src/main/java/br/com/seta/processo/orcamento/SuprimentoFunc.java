...
//
//public class SuprimentoFunc extends TaskPage  {
//
//
...
//
//
//	public SuprimentoFunc(PageParameters pageParameters) throws HttpStatus401Exception, HttpStatus404Exception, ClientProtocolException, GenericHttpStatusException, IOException {
//		
...
//
//
//			natDespesaSelecionada     = new TextField<String>("natDespesaSelecionada", new PropertyModel<String>(naturezaDespesaModel, "historico"));
//			transportadoraSelecionada = new TextField<String>("transportadoraSelecionada", new PropertyModel<String>(transportadoraModel, "razaoSocial"));
//			pessoaSelecionada         = new TextField<String>("pessoaSelecionada", new PropertyModel<String>(pessoaModel, "nomeRazao"));
//			modeloDocSelecionado      = new TextField<String>("modeloDocSelecionado", new PropertyModel<String>(modeloDocModel, "descricao"));
...
//
//			add(empresaCombo, natDespesaSelecionada,datacompra,datainclusao,requisicaoContainer);
//			requisicaoContainer.add(empresaCombo, natDespesaSelecionada, pessoaSelecionada, transportadoraSelecionada, modeloDocSelecionado);
//
//		}
//	}
//
...
//					if ((cfopModel.getCfop()!=null) && (produtoModel.getSeqproduto()!=null) ) {
...
//						orReqitensdespesa.setNroitem(orReqitensdespesa.getNroitem());
//
//						if (!orReqitensdespesaProvider.find(orReqitensdespesa) ) {
//							orReqitensdespesaProvider.add(orReqitensdespesa);
//						}else {
//							setMensagemErro("Produto já existe em pre-cadastro", target);
//						}
//
//					}else {
//						setMensagemErro("Deve conter um produto em um cfop!", target);
//					}
...
//			};
//
//			itensContainer.add(cfopSelecionado, produtoSelecionado, Versaoprod, Unidadepadrao, Quantidade, Valor, VlrDesconto, VlrAcescimo, Inserir, dataViewOrReqitensdespesa);
...
//							target.add(requisicaoContainer, pessoasContainer);
...
//							target.add(requisicaoContainer, transportadoraContainer);
...
//							target.add(requisicaoContainer, modeloDocumentoContainer);
...
//							target.add(requisicaoContainer,naturezaContainer,itensContainer,orReqplanilhalanctoContainer);
...
//						SuprimentoFunc.this.setMensagemErro(e.getMessage(), target);
//					}
...
//						try {
//							executeRestAPI.execueteCaseWithVariable(username, password, orRequisicao, "requisicao", processName, processVersion);
//							SuprimentoFunc.this.setMensagemErro("Enviada com sucesso !", target);
//						}catch (BonitaException e) {
//							SuprimentoFunc.this.setMensagemErro(e.getMessage(), target);
//						}catch (Exception e) {
//							SuprimentoFunc.this.setMensagemErro("Erro inesperado "+e.getMessage(), target);	
//						}
...
//				@Override
//				protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
//					SuprimentoFunc.this.setMensagemErro("Teste Mensagem enviada",target);
//				}
//			};
//
...
////	public void clear() {
////		empresaModel =   null;
////		naturezaDespesaModel = null; 
////		transportadoraModel =  null;
////		pessoaModel = null;
////		modeloDocModel = null;
////		valoresModel =  null;
////		cfopModel =  null;
